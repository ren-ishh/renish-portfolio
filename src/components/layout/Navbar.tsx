    ...
    <>
        ...
        >
          ...
          >
            ...
            <Link href="/" style={{ textDecoration: "none", display: "flex", alignItems: "center", gap: "6px" }}>
              <span style={{ color: "white", fontWeight: 700, fontSize: "1.1rem", letterSpacing: "-0.03em" }}>
                {siteConfig.name}
              </span>
              <motion.span
                style={{ display: "block", width: 6, height: 6, borderRadius: "50%", background: "white" }}
            ...
            {/* desktop links */}
            <ul style={{ display: "flex", listStyle: "none", gap: "2px" }} className="hidden-mobile">
              {NAV.map(({ label, href }) => {
      ...
      <AnimatePresence>
        {open && (
          ...
          >
            <div style={{ display: "flex", justifyContent: "flex-end", padding: "1.2rem 1.2rem 0" }}>
              <button
                onClick={() => setOpen(false)}
                style={{ display: "flex", padding: "8px", borderRadius: "8px", border: "none", background: "rgba(255,255,255,0.06)", color: "white" }}
              >
                <X size={20} />
              </button>
            </div>

            <nav style={{ display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", flex: 1, gap: "2px" }}>
                ...
                >
                  <a
                    ...
                    style={{
                      ...
                      color:          active === href.slice(1) ? "white" : "rgba(255,255,255,0.3)",
                      textDecoration: "none",
                    }}
                  >
                    {label}
            ...
            <div style={{ display: "flex", justifyContent: "center", gap: "20px", padding: "1.5rem", borderTop: "1px solid rgba(255,255,255,0.055)" }}>
              {[
                { href: siteConfig.github,  Icon: Github   },
                { href: siteConfig.linkedin, Icon: Linkedin },
              ].map(({ href, Icon }) => (
                <a key={href} href={href} target="_blank" rel="noreferrer" style={{ color: "rgba(255,255,255,0.32)" }}>
                  <Icon size={18} />
                </a>
              ))}
            </div>
